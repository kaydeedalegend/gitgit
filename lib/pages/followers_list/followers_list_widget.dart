                        ...
                        FutureBuilder<ApiCallResponse>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            return Builder(
                              builder: (context) {
                                final userFollowers =
                                    GitHubGroup.getUserFollowersCall
                                            .followers(
                                              gridViewGetUserFollowersResponse
                                                  .jsonBody,
                                            )
                                            ?.toList() ??
                                        [];
                                ...
                                return RefreshIndicator(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, userFollowersIndex) {
                                      final userFollowersItem =
                                          userFollowers[userFollowersIndex];
                                      return InkWell(
                            ...
                            return Builder(
                              builder: (context) {
                                final userFollowing = GitHubGroup
                                    .getUserFollowingCall
                                    .following(
                                      gridViewGetUserFollowingResponse.jsonBody,
                                    )
                                    .toList();
                                ...
                                return RefreshIndicator(
                                  ...
                                  child: GridView.builder(
                                    ...
                                    itemBuilder: (context, userFollowingIndex) {
                                      final userFollowingItem =
                                          userFollowing[userFollowingIndex];
                                      return InkWell(
                                        splashColor: Colors.transparent,
                                        focusColor: Colors.transparent,
                                        hoverColor: Colors.transparent,
